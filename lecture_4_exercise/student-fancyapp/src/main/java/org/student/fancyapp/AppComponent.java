...
public class AppComponent {
    ...
    This is what you should achieve:
     ...
     In principle the only blocked is H2 ping H3, all the other are allowed.
     */
            ...
            if (ethPkt.getEtherType() == Ethernet.TYPE_IPV4) {
                ...
                (ethPkt.getSourceMAC().toString().equals(STRING_SOMETHING) &&
                    ...
                    treatmentBuilder.setOutput(outPort).build(); //this is defining the action that we want in the entry in the flow table of the switch
                        ...
                        ethPkt.getDestinationMAC().toString().equals(STRING_SOMETHING)) {
                    log.info("BLOCKED: H_SOMETHING <-> H_SOMETHING");
                    context.block();
                    return;
                } else if
                (ethPkt.getSourceMAC().toString().equals(STRING_SOMETHING) &&
                ...
                flowObjectiveService.forward(DeviceId.deviceId(STRING_SOMETHING_2),forwardingObjective); //this creates the flow entry in the switch
